...
const LuckyWheel = () => {
  return (
    <main className="flex overflow-hidden flex-col pb-12 bg-white">
      ...
      <HeroSection />
      <DailyReward />
      <section className="self-center mt-9 w-full max-w-[1089px] max-md:max-w-full">
        <div className="flex gap-5 max-md:flex-col">
          <div className="w-[69%] max-md:ml-0 max-md:w-full">
            <div className="flex flex-wrap gap-9 items-start text-black max-md:mt-10">
              <FeatureCard
                title="Fast delivery"
                description="We prepare and ship your package the day after your order."
                icon="https://cdn.builder.io/api/v1/image/assets/TEMP/f2194649abe315dbba8e7e81b5c6a32b5611fb2e787f5ac291c9ef4cc4f68e4c?placeholderIfAbsent=true&apiKey=21fc27d6e38c4b9bbac843334566989c"
              />
              <FeatureCard
                title="In-Store pickup"
                description="Prefer to collect your order? Choose free same-day pickup at our store located in Ariena."
                extraIcon="https://cdn.builder.io/api/v1/image/assets/TEMP/187c838cf51c53b5eb039e16bda24b3deb638a7a0278f8daec87dfef40375c8a?placeholderIfAbsent=true&apiKey=21fc27d6e38c4b9bbac843334566989c"
              />
            </div>
          </div>

          <div className="ml-5 w-[31%] max-md:ml-0 max-md:w-full">
            <div className="flex grow gap-4 text-black max-md:mt-10">
              <FeatureCard
                title="Secure Payment"
                description='Payments are processed through Monetique Tunisie&apos;s "Clictopay" platform. We do not store any banking information.'
                extraIcon="https://cdn.builder.io/api/v1/image/assets/TEMP/4510593ca30a7c3bb9305a73fa26ad6de7d341778979ea6366f796aa35bd4419?placeholderIfAbsent=true&apiKey=21fc27d6e38c4b9bbac843334566989c"
              />
            </div>
          </div>
        </div>
