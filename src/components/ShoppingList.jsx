...
const ShoppingList = () => {
  ...
  return (
    <main className="flex overflow-hidden flex-col bg-stone-50">
      <nav
        className="px-16 py-7 w-full text-xl font-light tracking-normal leading-none text-black bg-zinc-100 max-md:px-5 max-md:max-w-full"
        aria-label="breadcrumb"
      >
        <p className="text-left ml-24">
          Home &gt; loyality &gt;{" "}
          <span className="font-bold">Your Shopping List</span>
        </p>
      </nav>
